class Lazycron < Formula
  ...
  homepage "https://github.com/undont/lazycron"
  version "0.2.7"
  license "MIT"

  on_macos do
    on_arm do
      url "https://github.com/undont/lazycron/releases/download/v0.2.7/lazycron-darwin-arm64"
    ...
    on_intel do
      url "https://github.com/undont/lazycron/releases/download/v0.2.7/lazycron-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/undont/lazycron/releases/download/v0.2.7/lazycron-linux-arm64"
    ...
    on_intel do
      url "https://github.com/undont/lazycron/releases/download/v0.2.7/lazycron-linux-amd64"
